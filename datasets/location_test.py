...
class ImageDataset(Dataset):
    def __init__(self,
        ...
        for my_scene in NUSC.scene:
            ...
            area_info = NUSC.log[area_count]['location']
            # area_count += 1
            ...
            while True:
                ...
                all_episode_data.append([first_sample, cam_front_data, anno,area_info])
    ...
    def __getitem__(self, idx):
        ...
        sample, cam_front_data, anno, area_info = all_episode_data[index]
        ...
        # print("here is the speed you need: " + speed + "\n")
        # print(area_info)
...
class ImageDataset_withobj(Dataset):
    def __init__(self,
        ...
        print("the lenght is: " + str(len(NUSC.log)) + "\n")
        ...
        for log in NUSC.log:
            log_area = log['location']
            log_token = log['token']
            log_dir[log_token] = log_area
            # print(dir)
        for my_scene in NUSC.scene:
            ...
            # area_info = NUSC.log[area_count]['location']
            # print(area_info)
            log_token = my_scene['log_token']
            area_info = log_dir.get(log_token)
            print(area_info)

            # print(area_count)
            # if(area_count > 0):
            #     if(log_token != last_log):
            #         area_count += 1
            # else:
            #     area_count += 1
            # last_log = my_scene['log_token']
            # print(area_info)
            # area_count += 1
            # print(scene_name)
    ...
    def __getitem__(self, idx):
        ...
        # area_info = NUSC.log[index]['location']
        print(area_info)
        ...
        # print("here is the speed you need: " + str(speed) + "\n")
        # print("here is the cmd you need: " + str(cmd) + "\n")
        # print(np.array(locations_vehicle))
        

        return rgb_images, rgb_name, np.array(locations_vehicle), cmd, speed,  object_all_info, area_info
...
if __name__ == '__main__':
    ...
    for rgb_img, rgb_name, locations, cmd, speed,object_all_info, area_info in tqdm.tqdm(loader):
