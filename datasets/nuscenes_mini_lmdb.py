...
val_split = [30, 61, 38, 126, 259, 291, 298, 316, 362, 365, 376, 378, 410, 429, 471, 504, 507, 524, 527, 542, 770, 781, 797, 810, 819, 852, 
...
test_split = [847, 816, 321, 135, 1010, 712, 458, 288, 418, 1004, 425, 20, 514, 244, 372, 671, 886, 154, 455, 229, 357, 870, 795, 1, 
        ...
        430, 461, 670, 366, 963, 573, 703, 64, 969, 930, 1102, 211, 442, 271, 518, 639, 926, 1013, 545, 595, 768, 734, 980, 47, 
...
class ImageDataset(Dataset):
    def __init__(self, 
        dataset_path = '/home/zhangjim/jimuyang/lbwyt/nuscenes-mini/',
    ...
    def __getitem__(self, idx):
        ...
        return rgb_images, np.array(locations), speed, cam_front_data['filename']
