...
class AV2Sample():
    ...
    def __init__(self, log_id, image_folder_path, image_file_name, city_name, av2_sensor_dataloader):
        ...
        self.next_next_location = None
        self.previous_location = None
        self.previous_previous_location = None
        self.next_timestamp = None
        self.next_next_timestamp = None
...
class AV2Dataset():
    ...
    def __init__(self,
        ...
        for log_id in log_ids:
            ...
            for index in range(len(log_all_samples) - 1):
                ...
                if index != len(log_all_samples) - 2:
                    log_all_samples[index].next_next_timestamp = log_all_samples[index + 2].timestamp
                    log_all_samples[index].next_next_location = log_all_samples[index + 2].location
            ...
            for index in range(1, len(log_all_samples)):  #
                ...
                if index != 1:
                    log_all_samples[index].previous_previous_timestamp = log_all_samples[index - 2].timestamp
                    log_all_samples[index].previous_previous_timestamp = log_all_samples[index - 2].location
    ...
    def __getitem__(self, index):
        ...
        return sample.get_image_tensor(self.crop_and_resize), str(
            sample.image_path), sample.trajectory, sample.command, sample.velocity, cityid
