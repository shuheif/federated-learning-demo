NUSCENES_DATASET_JT_VERSION="v1.0"
...
'''
Based on datasets/nuscenes_allbos.py
Adapted by JT
...
class NuScenesDataset(Dataset):
    def __init__(self,
        ...
        @param dataset_path:
            supported
                '/data/jimuyang/nuscenes/'
        @param cities:
                supported
                    ['BOS_TRAIN','SGP_VAL','SGP_TEST']
        @param gap: 5
        '''
        ...
        print("Finished loading %s. Length: %d" % (dataset_path, len(self.jtsamples)))
