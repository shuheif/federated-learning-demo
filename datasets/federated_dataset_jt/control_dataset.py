...
from .nuscenes_with_control import NuScenesDataset
from .av2_with_control import AV2Dataset
...
class FederatedDataset():
    def __init__(self, av2_cities=None, ns_cities=None, wm_cities=None, av2_root="/data/shared/av2_all/train",
                 ns_train_proportion=0.8, ns_train_test="TRAIN", waymo_train_test="TRAIN", waymo_p=1):
    ...
    def set_waymo(self, cities, tfrecords_dir="/data/shared/waymo_val", proportion=1.0,
        ...
        from .waymo_with_control import WaymoDataset
        '''
...
if __name__ == "__main__":
    datasets = FederatedDataset(av2_cities=['PIT'], ns_cities=None,
